...
Remember to use "email" lower case for the email input, like so: <input type="text" name="email">
...
Enter the email address below to send the contents of the form to.  Like this for example: $my_email = "webmaster@example.com";   If desired, you can enter more than one email address separated by commas, like so: $my_email = "someone@business.com,someoneelse@store.com";

*/

$my_email = "contact@nerdherd4043.org";
...
$required_fields = array('name','volunteer','phone','email','message');
...
$blocked_words = array('http://','https://','viagra','sex','porn','SEO','directories','bit.ly','sales','advertising','click','hack','hacking','hacked','database' );
...
$gibberish_fields_to_exclude = array('email', 'message');
...
$autoresponse_email_template_filename = "";
...
$field_order_keys = array('name','volunteer','phone','email','message');
...
$file_types_to_block = array('.com','.bat','.exe','.zip');
...
$file_types_to_allow = array('.pdf','.jpg','.png');
...
$show_attachments_in_email_body = 0;
